...
export const demoStudents: DemoStudent[] = [
  ...
  { id: 'stu-2', name: 'Diego R.', groupId: '', phase: 'Phase 1', progressPercent: 18, progressLabel: '7/36 lessons', focusAreas: ['Sound ID', 'Attention'], assessmentStatus: 'In progress' },
  ...
  { id: 'stu-5', name: 'Nia S.', groupId: '', phase: 'Phase 1', progressPercent: 27, progressLabel: '10/36 lessons', focusAreas: ['Listening', 'Sequencing'], assessmentStatus: 'Screening' },
  ...
  { id: 'stu-8', name: 'Sam T.', groupId: 'grp-b', phase: 'Phase 1', progressPercent: 22, progressLabel: '8/36 lessons', focusAreas: ['Sound ID', 'Attention'], assessmentStatus: 'In progress' },
